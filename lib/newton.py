    ...
    for i in range(3, m - 3):
        for j in range(3, n - 3):
            ...
            Y1[i, j] = 0.5 * I[i, j] + 0.0625 * I[i - 3, j - 3] - 0.25 * I[i - 2, j - 2] + 0.4375 * \
                I[i - 1, j - 1] + 0.4375 * I[i + 1, j + 1] - 0.25 * \
                I[i + 2, j + 2] + 0.0625 * I[i + 3, j + 3]
    ...
    for i in range(3, m - 3):
        for j in range(3, n - 3):
            ...
            XX2[i, j] = XX2[i, j] + 0.4375 * \
                R[i - 1, j, O[i, j + 1]] + 0.4375 * \
                R[i + 1, j, O[i, j + 1]]
            XX2[i, j] = XX2[i, j] - 0.25 * I[i + 2, j] + \
                0.0625 * R[i + 3, j, O[i, j + 1]]
            ...
            YY2[i, j] = YY2[i, j] + 0.4375 * \
                R[i, j - 1, O[i + 1, j]] + \
                0.4375 * R[i, j + 1, O[i + 1, j]]
            YY2[i, j] = YY2[i, j] - 0.25 * I[i, j + 2] + \
                0.0625 * R[i, j + 3, O[i + 1, j]]

    # Fusion of the estimations with edge classifier
    ...
    for i in range(3, m - 4):
        for j in range(3, n - 4):
            ...
            for k in range(-2, 3, 2):
                for l in range(-2, 3, 2):
                    pha1 = pha1 + \
                        abs(XX1[i + k, j + l] - I[i + k, j + l])
                    pha2 = pha2 + \
                        abs(XX2[i + k, j + l] - I[i + k, j + l])
